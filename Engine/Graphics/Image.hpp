...
namespace dms::gfx {
	...
	public:
		...
		///
		////////////////////////////////////////////////////////////
		//bool loadFromStream(io::stream::InputStream& stream);
		...
		///
		////////////////////////////////////////////////////////////
		bool saveToMemory(std::vector<uint8_t>& output, const std::string& format) const;
		...
		///
		////////////////////////////////////////////////////////////
		void copy(const Image& source, unsigned int destX, unsigned int destY, const core::IntRect& sourceRect = core::IntRect(0, 0, 0, 0), bool applyAlpha = false);
