...
/**
 * @file ThreadImpl.hpp
 * @brief Platform-specific implementation details for dms::Thread.
 *
 * Contains the PIMPL-like backing class used by dms::Thread to manage
...
namespace dms::core {
	...
	public:
		 ...
		 * have exited. Thread lifetime semantics are coordinated with dms::Thread.
		 */
		~ThreadImpl();
#endif
